...
=====================================
架構：bge-m3 embedding → Pinecone 向量搜尋 → Gemini 1.5 Flash 生成
...
請依據以下提供的法規條文回答使用者的問題。

規則：
1. 使用繁體中文回答
2. 引用相關條文或來源（格式：依《來源名稱》第X條…）
3. 若提供的條文不足以回答，請誠實說明，不要捏造內容
4. 回答簡潔、結構清晰，適當分段
...
st.caption(
    ...
    "模型：BAAI/bge-m3 + Gemini 1.5 Flash"
)
