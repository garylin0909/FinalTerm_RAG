...
FOOD_TOPIC_TERMS = (
    ...
    "微生物", "動物用藥", "膠囊", "錠", "錠狀", "保健", "保健食品", "草本",
    "萃取", "生技", "生物科技", "三高", "血壓", "血糖", "血脂", "抗癌", "防癌",
    "糖尿病", "高血壓", "慢性病", "關節炎", "免疫", "根治", "不復發",
)
...
QUESTION_TYPE_RULES = [
    ...
    (
        "ad_copy",
        (
            "廣告", "宣稱", "文案", "療效", "誇張", "不實", "易生誤解", "改善",
            "降低", "預防", "治療", "降三高", "血壓", "血糖", "血脂", "抗癌",
            "防癌", "糖尿病", "高血壓", "關節炎", "慢性病", "根治", "不復發",
            "醫學奇蹟",
        ),
    ),
    (
